...
import { DefaultExtensionOptions, PlainExtension } from '../extension';
...
export class KeymapExtension extends PlainExtension<KeymapOptions> {
  ...
  static readonly defaultOptions: DefaultExtensionOptions<KeymapOptions> = {
    undoInputRuleOnBackspace: true,
    selectParentNodeOnEscape: false,
    excludeBaseKeymap: false,
  };

  static readonly customHandlerKeys: CustomHandlerKeyList<KeymapOptions> = ['keymap'];
